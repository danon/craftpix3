...
from hex.core.GameWorld import GameWorld, Stance, Turn
...
class Application(ForRunningGame):
    ...
    def tick(self):
        ...
        pos = Point(self.__game_world.player.x, 0)
        if self.__game_world.player.stance == Stance.Idle:
        ...
        self.__window.draw_frame(
            ...
            pos,
            self.__game_world.player.turn == Turn.Left)
        self.__window.draw_text(str(self.__game_world.player.stance), pos)
